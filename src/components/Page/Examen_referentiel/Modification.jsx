                        ...
                        <form className='flex flex-column justify-content-center'>
                            <div className='grid px-4'>
                                <div className="lg:col-3  field my-0  flex flex-column">
                                    ...
                                    {verfChamp.code_client ? <small id="username2-help" className="p-error block">Id Examen vide !</small> : null}
                                </div>
                            </div>

                            <div className='grid px-4'>
                                <div className="lg:col-6 col-12 field my-0 flex flex-column">
                                    <label htmlFor="username2" className="label-input-sm">Libelée*</label>
                                ...
                                <div className="lg:col-6 col-12 field my-0 flex flex-column">
                                    ...
                                    <Dropdown options={props.choixTarif} placeholder="choisir Tarif" />
                                </div>
                                <div className="lg:col-6 col-12 field my-0 flex flex-column">
